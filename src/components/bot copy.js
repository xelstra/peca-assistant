...
//             chat(currentMsg).then((response) => { let bot = { text: response, isUser: false }; console.log(bot); setBotResponse(bot) });
//             const timer = setTimeout(() => {
//                 if (botResponse !== null) {
//                     setMessages([...messages, botResponse]);
//                     saveMessages(currentMsg.text, botResponse.text)
//                     console.log(messages);
//                     setBotResponse(null)
//                 }
//             }, 10);

//             // Clean up the timer when the component unmounts or when a new message is sent
...
//                     />
//                     <button onClick={handleSendMessage} type='submit' className={`fs-4 p-1 ps-2 pe-3 send`}><FontAwesomeIcon icon={faPaperPlane} className='clr3' /></button>
//                 </form>
//             </div>
